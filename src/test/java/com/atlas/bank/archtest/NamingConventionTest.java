...
public class NamingConventionTest {
    ...
    static final ArchRule use_cases_should_reside_in_port_in =
            classes()
                    ...
                    .because("Los use cases son puertos de entrada - vive en application/port/in");
    ...
    static final ArchRule port_out_should_be_interfaces =
            classes()
                    ...
                    .should().beInterfaces()
                    .because("Los puertos de salida definen que necesita la aplicacion - la implementacion va en infraestructura");
}
